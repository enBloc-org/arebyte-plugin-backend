...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    favourites: Attribute.Relation<
      ...
      'api::pop-up.pop-up'
    >;
    digest_counter: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiContentCreatorContentCreator extends Schema.CollectionType {
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    launch_date: Attribute.Date & Attribute.Required;
    cover_image: Attribute.Media<'images'> & Attribute.Required;
    content_creator: Attribute.Relation<
      'api::project.project',
      'manyToOne',
      'api::content-creator.content-creator'
    >;
